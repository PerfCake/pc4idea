...
//            @Override
//            public void actionPerformed(ActionEvent e) {
//                DestinationGUI.this.openEditorDialogAndGetResult();
//            }
//        });
...
//        DestinationEditor todo = new DestinationEditor();
//        todo.setDestination(destination);
//        ScenarioDialogEditor dialog = new ScenarioDialogEditor(todo);
//        dialog.show();
//        if (dialog.getExitCode() == 0){
//            setComponentModel(todo.getDestination());
