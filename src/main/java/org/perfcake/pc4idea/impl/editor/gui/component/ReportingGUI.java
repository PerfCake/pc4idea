...
//                ReporterEditor todo = new ReporterEditor();
//                ScenarioDialogEditor dialog = new ScenarioDialogEditor(todo);
//                dialog.show();
//                if (dialog.getExitCode() == 0) {
//                    Scenario.Reporting.Reporter reporter = todo.getReporter();
...
//                    PropertyEditor todo = new PropertyEditor();
//                    ScenarioDialogEditor dialog = new ScenarioDialogEditor(todo);
//                    dialog.show();
//                    if (dialog.getExitCode() == 0) {
//                        Property property = todo.getProperty();
...
//        ReportingEditor todo = new ReportingEditor();
//        todo.setReporting(reporting);
//        ScenarioDialogEditor dialog = new ScenarioDialogEditor(todo);
//        dialog.show();
//        if (dialog.getExitCode() == 0) {
//            this.setComponentModel((todo.getReporting().getReporter().isEmpty()) ?
//                    null : todo.getReporting());
