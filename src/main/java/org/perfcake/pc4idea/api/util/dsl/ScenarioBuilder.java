...
public class ScenarioBuilder {
    ...
    String buildScenario(Scenario model, String name){
        ...
        sb.append(buildGenerator(model.getGenerator()));
    ...
    private String buildGenerator(Scenario.Generator model){
        String run = "  run " + buildPeriod(model.getRun().getType(), model.getRun().getValue()) +
                " with " + model.getThreads() + ".threads\n";

        String generator = "  generator \"" + model.getClazz() + "\"" + buildProperties(model.getProperty());
