...
import org.perfcake.pc4idea.editor.swing.tablemodels.SenderPropertiesTableModel;
...
public class SenderPropertiesTable extends JBTable {
    ...
    public SenderPropertiesTable() {
        this.setModel(new SenderPropertiesTableModel());
        ...
        DefaultTableCellRenderer defaultRenderer = new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
                ...
                SenderPropertiesTableModel model = (SenderPropertiesTableModel) table.getModel();
    ...
    public void updateModelProperties(List<Property> modelPropertyList) {
        this.modelPropertyList = modelPropertyList;
        update();
    }

    public void updateStructure(List<Property> structurePropertyList) {
    ...
    private void update() {
        ...
        ((SenderPropertiesTableModel) this.getModel()).updateModel(tableHints, tableProperties);
        this.revalidate();
        this.repaint();
    }
}
