 ...
 */
public class ReporterGUI extends AbstractComponentGUI implements Activatable, ChildrenHaveGUI{
    ...
    public ReporterGUI(AbstractComponentGUI parent){
