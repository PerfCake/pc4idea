package org.perfcake.pc4idea.editor.colors;
...
import org.perfcake.pc4idea.editor.gui.ScenarioGUI;
...
public class ColorComponents {
    ...
    /**
     * Sets new colors for all ColorTypes (PerfCake GUI gui) and updates them in current open editors.
     *
